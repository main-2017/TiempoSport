  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/futbol/"><img src="<?php bloginfo( 'template_url' ); ?>/img/futbol.png" class="icon-btn">Fútbol</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/motores/"><img src="<?php bloginfo( 'template_url' ); ?>/img/motores.png" class="icon-btn">Motores</a>
            </li>
              <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/polideportivo/"><img src="<?php bloginfo( 'template_url' ); ?>/img/polideportivo.png" class="icon-btn">Polideportivo</a>
            </li>
              <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/extras/"><img src="<?php bloginfo( 'template_url' ); ?>/img/extras.png" class="icon-btn">Extras</a>
            </li>
