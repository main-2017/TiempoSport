  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/extras/general-extras/"><img src="<?php bloginfo( 'template_url' ); ?>/img/extras.png" class="icon-btn">General</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/extras/memoria-emotiva/"><img src="<?php bloginfo( 'template_url' ); ?>/img/memoria-emotiva.png" class="icon-btn">Memoria&nbsp;Emotiva</a>
            </li>
              <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/extras/te-seguimos/"><img src="<?php bloginfo( 'template_url' ); ?>/img/te-seguimos.png" class="icon-btn">Te&nbsp;Seguimos</a>
            </li>
              <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/extras/la-zurda-inmortal/"><img src="<?php bloginfo( 'template_url' ); ?>/img/la-zurda-inmortal.png" class="icon-btn">La&nbsp;Zurda&nbsp;Inmortal</a>
            </li>
