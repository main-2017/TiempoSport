...
<body <?php body_class(); ?>>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/futbol/general/"><img src="<?php bloginfo( 'template_url' ); ?>/img/futbol.png" class="icon-btn">General</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/futbol/local/"><img src="<?php bloginfo( 'template_url' ); ?>/img/local.png" class="icon-btn">Local</a>
            </li>
              <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/futbol/semillero/"><img src="<?php bloginfo( 'template_url' ); ?>/img/semillero.png" class="icon-btn">Semillero</a>
            </li>
              <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/futbol/aficionado/"><img src="<?php bloginfo( 'template_url' ); ?>/img/aficionado.png" class="icon-btn">Aficionado</a>
            </li>
