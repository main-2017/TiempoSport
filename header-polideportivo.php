  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/polideportivo/general-polideportivo/"><img src="<?php bloginfo( 'template_url' ); ?>/img/polideportivo.png" class="icon-btn">General</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/polideportivo/hockey/"><img src="<?php bloginfo( 'template_url' ); ?>/img/hockey.png" class="icon-btn">Hockey</a>
            </li>
              <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/polideportivo/tenis/"><img src="<?php bloginfo( 'template_url' ); ?>/img/tenis.png" class="icon-btn">Tenis</a>
            </li>
              <li class="nav-item">
              <a class="nav-link" href="http://c0360477.ferozo.com/palabrasredondas/category/polideportivo/rugby/"><img src="<?php bloginfo( 'template_url' ); ?>/img/rugby.png" class="icon-btn">Rugby</a>
            </li>
